    ...
    <el-main style="background: #f8f9fa; padding: 20px;">
      <el-card body-style="padding: 30px;">
        ...
        <el-descriptions title="" border :column="3" style="margin-bottom: 24px;">
          <!-- 第一行 -->
          <el-descriptions-item label="来文类型">{{ doc.docType || '无' }}</el-descriptions-item>
          <el-descriptions-item label="来文日期">{{ doc.receiveDate | dateFormat }}</el-descriptions-item>
          <el-descriptions-item label="来文单位">{{ doc.senderOrg || '无' }}</el-descriptions-item>

          <!-- 第二行 -->
          <el-descriptions-item label="联系人">{{ doc.contactPerson || '无' }}</el-descriptions-item>
          <el-descriptions-item label="联系电话">{{ doc.contactPhone || '无' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="年度">{{ doc.annual || '无' }}</el-descriptions-item>
          <el-descriptions-item label="份数">{{ doc.copies || '1' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="文种/期号">{{ doc.documentType || '无' }}</el-descriptions-item>

          <!-- 第五行 -->
          <el-descriptions-item label="盒号">{{ doc.boxNo || '无' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="归档号">{{ doc.archiveNo || '无' }}</el-descriptions-item>
